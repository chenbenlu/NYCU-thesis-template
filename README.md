...
* 想用GitHub Actions 自動編譯 PDF, 可以參考這邊: https://github.com/chenbenlu/NYCU-thesis-template
  * 來源: https://github.com/coldwufish/NYCU-thesis-template/pull/18

* 參考文獻格式為APA格式的話, 可以參考這邊: https://www.overleaf.com/read/dnqhdsxjhqqr#2db9aa
  * 這個版本的bib文獻內容也要跟著調整, 可以參考連結的bib檔例子
  * 來源: https://github.com/coldwufish/NYCU-thesis-template/issues/5
...
* 2025.10: 修正目錄排版間隔, 封面改為Mater's Thesis, 找到一兩個錯字, 補充latex撰寫常見注意事項於附錄.
* 2026.07: 更新README, 補充APA文獻格式 & 使用Github編譯PDF的連結, 把warnning消掉了